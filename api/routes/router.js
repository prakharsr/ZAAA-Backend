...
router.get('/plans', plan.getPlans2);
router.get('/plans2', plan.getPlans);
router.post('/user/plan', firm.setPlan2);
...
router.post('/user/notes/releaseOrder/search/', notes.queryMediaHouseNoteForRO);
